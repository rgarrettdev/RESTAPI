...
switch ($page) {
    case '1':
        ...
        case '8':
        $request = "/api/presentations/advanced/virtual/paper";
        $result = "{
            'status': 200,
            'message': {
                'text': 'Records found'
        ...
        $info = "N/A";
        Documentation::docEndpoint("/api/presentations/advanced/:searchterm/:categoryname", $request, $result, $info);
        break;
